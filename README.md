...
* [NCI Genomic Data Commons - The GDC Data Portal](https://gdc.cancer.gov/access-data/gdc-data-portal)
...
* [Rfam - The Rfam database is a collection of RNA families](https://docs.rfam.org/en/latest/database.html)
...
* [Aviation Weather Center - Consistent, timely and accurate weather data](https://aviationweather.gov/adds/dataserver)
* [Brazilian Weather - Historical data (In Portuguese)](http://sinda.crn.inpe.br/PCD/SITE/novo/site/historico/index.php)
...
* [Dutch Weather - The KNMI Data Center (KDC)](https://data.knmi.nl/datasets)
* [European Climate Assessment & Dataset](https://www.ecad.eu/)
* [Global Climate Data Since 1929](http://en.tutiempo.net/climate)
* [Charting The Global Climate Change News Narrative 2009-2020](https://blog.gdeltproject.org/four-massive-datasets-charting-the-global-climate-change-news-narrative-2009-2020/)
...
* [Bangkok Housing Pipeline and Planning Registers - 8 CC BY 4.0 tables on residential construction underway in the Bangkok Metropolitan Region, compiled from the public listings of Thailand's nine largest listed developers and re-checked every two days, plus joins to the city plan (floor area ratio per zone), the national EIA register (approved filings not yet started), the city's monitored flood points and OpenStreetMap amenities. CSV and JSON with a column dictionary, no sign-up. Thailand has no public transaction registry, so these are published asking prices, not sales](https://baanscope.com/data)
* [CoworkingView Coworking Price Index - median monthly asking price per desk for coworking spaces and private offices in 62 cities across Europe and the Gulf, with the per-type medians, the sample size and an explicit low-confidence flag on every row, built only from the rates operators publish themselves, CC BY 4.0 as CSV and JSON through a keyless API](https://coworkingview.com/en/tools/price-index)
...
* [The Public Utility Data Liberation Project (PUDL)](https://github.com/catalyst-cooperative/pudl)
* [REDD](http://redd.csail.mit.edu/)
* [Smart Meter Data Portal](https://smda.github.io/smart-meter-data-portal)
...
* [Prostate-3T - The Prostate-3T project provided imaging data to TCIA](https://wiki.cancerimagingarchive.net/display/Public/PROSTATE-3T)
* [Prostate-Adenocarcinoma-Broad-Cornell-2012](http://www.cbioportal.org/study?id=prad_broad)
* [Prostate-Adenocarcinoma-Broad-Cornell-2013](http://www.cbioportal.org/study?id=prad_broad_2013)
* [Prostate-Adenocarcinoma-CNA-study-MSKCC - Copy-number profiling of 103](http://www.cbioportal.org/study?id=prad_mskcc_2014)
* [Prostate-Adenocarcinoma-Fred-Hutchinson-CRC](http://www.cbioportal.org/study?id=prad_fhcrc)
...
* [QIN-PROSTATE-Repeatability - The QIN-PROSTATE-Repeatability dataset](https://wiki.cancerimagingarchive.net/display/Public/QIN-PROSTATE-Repeatability)
...
* [SEER-YR1973_2015.SEER9 - The SEER November 2017 Research Data files](https://seer.cancer.gov/data/seerstat/nov2017/)
...
* [SEER-YR2000_2015.CA_KY_LO_NJ_GA - The July - December 2005 diagnoses](https://seer.cancer.gov/data/seerstat/nov2017/)
...
* [Philippines PCSO Historical Draw Results (2022–2026) - Independently compiled 13,457-row snapshot across nine digit and jackpot games, with row-level provenance, CSV downloads, a data dictionary, reproducible validation notes, and CC BY 4.0 licensing. Not an official PCSO database.](https://remo65588-boop.github.io/lottolens-ph-public-data/)
